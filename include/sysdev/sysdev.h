...
#ifndef _SYSDEV_H_
#define _SYSDEV_H_
#define _SYSDEV_API_ __declspec(dllexport)
 ...
 * @return 状态码
 */
_SYSDEV_API_ StatusCode SysDevGetNetworkCardInfo(NetworkCardInfo **pInfo, size_t *size);
 ...
 * @return 状态码
 */
_SYSDEV_API_ StatusCode SysDevFreeNetworkCardInfo(NetworkCardInfo *pInfo, size_t size);
